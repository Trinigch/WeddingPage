  ...
  return (
    <Container>
      ...
      <Section
        ...
        text="We want you to be part of this episode of our history... which will be at San Martín de los Andes, Neuquen, Argentina."
        reverse={false}
      />
      <Section
        image={churchImage}
      ...
      <Section
        ...
        text="The important thing is that you come with enthusiasm, joy, and the desire to have a good time. But if you want to give us a gift, here is our account number: 0000000000000000000000.  ~ dont bring big gifts to the wedding, we don't want to travel with its ~ "
      />
    </Container>
  );
}
...
//            <p>But if you want to give us a gift, here is our account number ~ dont bring big gifts to the wedding, we don't want to travel with its ~:</p> 
